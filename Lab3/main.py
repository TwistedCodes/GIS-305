...
def extract():
    ...
    r = requests.get("https://docs.google.com/spreadsheets/d/e/2PACX"
                     "-1vTaJ_1xRhGQAOSITkgn_C1wfPSnPX0BA37XuftlXVfVrpjfj4J3BHPu1soGeUtNt3XjLI1G_HT2Fy69/pub?output"
                     "=csv")
    r.encoding = "utf-8"
    data = r.text
